...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    faqs: [
      { question: 'Is Sky Lagoon or Blue Lagoon better?', answer: 'Sky Lagoon is better for most visitors: from £87 against £108, rated 4.8 from 7,408 reviews against 4.6 from 6,031, and minutes from Reykjavik rather than 45 minutes away. Choose the Blue Lagoon for the famous setting or for an airport day.' },
      { question: 'How much is the Blue Lagoon?', answer: 'Blue Lagoon comfort admission starts from £108, which includes the lagoon, a silica mud mask and a drink. Sky Lagoon starts from £87 including the seven-step spa ritual.' },
