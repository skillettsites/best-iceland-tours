...
export const guides: Guide[] = [
  {
    ...
    sections: [
      { heading: 'Best skip-the-line tickets in Iceland', content: '<p>These highly rated Iceland experiences include skip-the-line or priority access, ranked by reviews:</p><ul><li><strong>Sky Lagoon Entrance Pass With 7-Step Spa Ritual</strong>: 4.8&#9733; from 7,182 reviews, from £86.</li><li><strong>LAVA SHOW - Immersive Experience Entry Ticket</strong>: 4.7&#9733; from 3,906 reviews, from £39.</li><li><strong>FlyOver Iceland Entry Ticket</strong>: 4.7&#9733; from 3,876 reviews, from £33.</li></ul>' },
  ...
  },
  {
    ...
    sections: [
      { heading: 'Start with the icons', content: '<p>On a first visit, the headline sights come first. Booking ahead guarantees entry and, where offered, skips the longest queues. These are the experiences first-timers book most:</p><ul><li><strong>Golden Circle, Kerid Crater, & Blue Lagoon Tour</strong>: 4.9&#9733; from 5,774 reviews, from £191.</li><li><strong>Guided Foodie Walking Tour with 6 Tastings</strong>: 4.9&#9733; from 1,873 reviews, from £112.</li><li><strong>Golden Circle Full-Day Tour with Kerid Crater</strong>: 4.8&#9733; from 26,338 reviews, from £67.</li><li><strong>South Coast Waterfalls, Black Sand & Glacier Tour</strong>: 4.8&#9733; from 12,056 reviews, from £88.</li><li><strong>Sky Lagoon Entrance Pass With 7-Step Spa Ritual</strong>: 4.8&#9733; from 7,182 reviews, from £86.</li></ul>' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How much do day trips from Reykjavik cost?', answer: 'Expect from £67 for a Golden Circle day, £72 for whale watching, £88 for the South Coast, £142 for a guided glacier hike and £191 for a combined Golden Circle and Blue Lagoon day.' },
