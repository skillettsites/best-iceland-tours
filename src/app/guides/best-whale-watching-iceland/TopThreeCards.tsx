        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-[280px_1fr]">
            <TrackedGYGLink
              ...
              section="whale-watching-which-boat-image"
            ...
            <div className="flex flex-col p-5 sm:p-6">
              ...
              <dl className="mt-4 grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-700 sm:grid-cols-3">
                ...
                <div>
                  <dt className="text-xs uppercase tracking-wide text-gray-500">Boat</dt>
                  <dd className="font-semibold text-gray-900">{ticket.boat}</dd>
                </div>
                <div>
              ...
              <TrackedGYGLink
                href={ticket.href}
                tourName={ticket.shortName}
                section="whale-watching-which-boat-cta"
                destination={ticket.bestFor}
